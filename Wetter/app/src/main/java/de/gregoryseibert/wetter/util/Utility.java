package de.gregoryseibert.wetter.util;
...
public class Utility {
    ...
    private final static String TODAY_TEXT = "Heute";
    private final static String TOMORROW_TEXT = "Morgen";
    ...
    private final static String FORMAT_DATE = "EEEE - dd.M.y";

    //units for the weather data
    private final static String UNIT_TEMPERATURE_M = " °C";
    private final static String UNIT_TEMPERATURE_I = "F";
    private final static String UNIT_WIND = " km/h";
    public final static String UNIT_PRESSURE = " hPa";
    public final static String UNIT_HUMIDITY = "%";

    //wind direction data holders
    private final static WindDirection WIND_DIR_1 = new WindDirection("Nord", R.string.wi_direction_down);
    private final static WindDirection WIND_DIR_2 = new WindDirection("Nord-Ost", R.string.wi_direction_down_left);
    private final static WindDirection WIND_DIR_3 = new WindDirection("Ost", R.string.wi_direction_left);
    private final static WindDirection WIND_DIR_4 = new WindDirection("Süd-Ost", R.string.wi_direction_up_left);
    private final static WindDirection WIND_DIR_5 = new WindDirection("Süd",  R.string.wi_direction_up);
    private final static WindDirection WIND_DIR_6 = new WindDirection("Süd-West", R.string.wi_direction_up_right);
    private final static WindDirection WIND_DIR_7 = new WindDirection("West", R.string.wi_direction_right);
    private final static WindDirection WIND_DIR_8 = new WindDirection("Nord-West", R.string.wi_direction_down_right);
    ...
    public static String formatTemperature(double temperature, boolean isMetric) {
        ...
        if (!isMetric) {
            ...
            return String.format(Locale.GERMAN, "%.0f%s", temp, UNIT_TEMPERATURE_I);
        } else {
            temp = temperature;
            return String.format(Locale.GERMAN, "%.0f%s", temp, UNIT_TEMPERATURE_M);
        }
    }

    public static String getFormattedWind(Context context, float windSpeed) {
        if (Utility.isMetric(context)) {
            return String.format(Locale.GERMAN, "%.0f%s", windSpeed, UNIT_WIND);
        } else {
            return String.format(Locale.GERMAN, "%.0f%s", .621371192237334f * windSpeed, UNIT_WIND);
        }
    }
    ...
    private static Utility.WindDirection getWindDirection(float windDeg) {
    ...
    public static String getDateString(long dateInMillis) {
        ...
        if (julianDay == currentJulianDay) {
            ...
            SimpleDateFormat dateFormat = new SimpleDateFormat(FORMAT_DATE, Locale.GERMAN);
    ...
    private static class WindDirection {
        ...
        WindDirection(String dir, int icon) {
            this.dir = dir;
            this.icon = icon;
        }
